              ...
              <div className="group">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-[#26150B]/30 border border-[#FBF7EF]/10 rounded-xl py-3.5 px-4 text-sm text-[#FBF7EF] placeholder-[#FBF7EF]/20 outline-none focus:border-[#FBF7EF]/40 focus:bg-[#26150B]/50 transition-all shadow-inner"
                    placeholder="••••••••"
                    required
                  />
                </div>
